...
def main():
    ...
    try:
        ...
        file_return = file_logic(tw_tup[2])

        # print out final copy stats
        file_size_success = byte_notation(file_return["val_size"])
        file_size_failure = byte_notation(tw_tup[3] - file_return["val_size"])
